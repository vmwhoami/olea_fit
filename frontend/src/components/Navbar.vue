<template>
  ...
  <nav
    class="flex-no-wrap fixed top-0 z-10 flex w-full items-center justify-between py-2 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4"
  >
    <router-link
      to="/"
